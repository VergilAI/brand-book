...
import { IconButton } from '@/components/diagram-tool/ui/IconButton'
        ...
        <>
          ...
          <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-30">
            <div className="p-4 space-y-4">
              {/* Grid Settings */}
              <div>
                <h4 className="text-sm font-medium text-primary mb-2">Grid</h4>
                <div className="space-y-2">
                  ...
                  {store.view.showGrid && (
                    <div className="flex items-center gap-2 pl-6">
                      <label className="text-sm text-secondary">Size:</label>
                      <input
                        type="number"
              ...
              {/* Snapping Settings */}
              <div>
                <h4 className="text-sm font-medium text-primary mb-2">Snapping</h4>
                <div className="space-y-2">
              ...
              {store.tool === 'pen' && (
                <div>
                  <h4 className="text-sm font-medium text-primary mb-2">Drawing</h4>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                  ...
                  <div className="text-xs text-tertiary mt-2 pl-6">
