      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-1 px-2 py-1.5 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200">
          ...
          <div className="flex items-center gap-1">
            {tools.map(tool => (
              <IconButtonWithTooltip
                ...
                className={cn(
                  "transition-colors",
                  store.tool === tool.id && "hover:bg-cosmic-purple/10"
                )}
              />
            ))}
          </div>
          ...
          <IconButtonWithTooltip
            ...
            className={cn(
              "transition-colors",
              store.view.showGrid && "hover:bg-cosmic-purple/10"
            )}
          />
          ...
          <IconButtonWithTooltip
            ...
            className={cn(
              "transition-colors",
              store.snapping.settings.enabled && "hover:bg-cosmic-purple/10"
            )}
          />
          ...
          <IconButtonWithTooltip
            ...
            className={cn(
              "transition-colors",
              store.templateLibrary.isOpen && "hover:bg-cosmic-purple/10"
            )}
          />
          ...
          <IconButtonWithTooltip
            ...
            className={cn(
              "transition-colors",
              store.territoryTable.isOpen && "hover:bg-cosmic-purple/10"
            )}
          />
